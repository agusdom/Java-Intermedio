...
public class InformacionEquipo extends javax.swing.JFrame {
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        int Validacion = 0;
        String Tipo_Equipo, Marca, Modelo, Num_Serie, Estatus, Observacaciones;
        ...
        Observacaciones = jTextPane_Observaciones.getText();
        ...
        if (Validacion == 0) {
            ...
            try {
                Connection cn = Conexion.Conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "update equipos set Tipo_Equipo = ?, Marca = ?, Modelo = ?, Numero_Serie = ?, Observaciones = ?, Estatus = ?, Ultima_Modificacion = ?"
                ...
                pst.setString(5, Observacaciones);
